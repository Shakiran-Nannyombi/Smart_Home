...
import com.example.smarthome.data.getNullableString
...
class SettingsViewModel(application: Application) : AndroidViewModel(application) {
    ...
    companion object {
        ...
        private val GOOGLE_ASSISTANT_KEY = booleanPreferencesKey("google_assistant")
    ...
    val appColor: Flow<Color> = dataStore.getColor(APP_COLOR_KEY, Color(0xFFFFD700))
    ...
    val isGoogleAssistantEnabled: Flow<Boolean> = dataStore.getBoolean(GOOGLE_ASSISTANT_KEY, false)
    ...
    val profileImage: Flow<String?> = dataStore.getNullableString(PROFILE_IMAGE_KEY, null)
    ...
    fun updateAppColor(color: Color) {
        viewModelScope.launch {
            dataStore.putColor(APP_COLOR_KEY, color)
        }
    }
    ...
    fun updateProfileImage(uri: String?) {
        viewModelScope.launch {
            dataStore.putString(PROFILE_IMAGE_KEY, uri ?: "")
        }
    }
}
